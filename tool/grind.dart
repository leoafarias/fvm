...
Future<void> buildVersion() async {
  ...
  final deployType = deployTypeArg ?? 'pub';

  if (!['pub', 'brew', 'chocolatey'].contains(deployType)) {
    throw Exception('Invalid deploy environment: $deployType');
  }
...
// Add comment on top of the const that this file is generated by this command
  ...
  fileContent += "const deployType = '$deployType';\n";
