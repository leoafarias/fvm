...
class FlutterRootVersionFileMapper
  ...
  static const Field<FlutterRootVersionFile, String> _f$flutterVersion = Field(
    'flutterVersion',
    _$flutterVersion,
    opt: true,
  );
  static String? _$channel(FlutterRootVersionFile v) => v.channel;
  static const Field<FlutterRootVersionFile, String> _f$channel = Field(
    'channel',
    _$channel,
    opt: true,
  );
  static String? _$repositoryUrl(FlutterRootVersionFile v) => v.repositoryUrl;
  static const Field<FlutterRootVersionFile, String> _f$repositoryUrl = Field(
    'repositoryUrl',
    _$repositoryUrl,
    opt: true,
  );
  ...
  static const Field<FlutterRootVersionFile, String> _f$engineRevision = Field(
    'engineRevision',
    _$engineRevision,
    opt: true,
  );
  ...
  static String? _$engineBuildDate(FlutterRootVersionFile v) =>
      v.engineBuildDate;
  static const Field<FlutterRootVersionFile, String> _f$engineBuildDate = Field(
    'engineBuildDate',
    _$engineBuildDate,
    opt: true,
  );
  static String? _$dartSdkVersion(FlutterRootVersionFile v) => v.dartSdkVersion;
  static const Field<FlutterRootVersionFile, String> _f$dartSdkVersion = Field(
    'dartSdkVersion',
    _$dartSdkVersion,
    opt: true,
  );
  static String? _$devToolsVersion(FlutterRootVersionFile v) =>
      v.devToolsVersion;
  static const Field<FlutterRootVersionFile, String> _f$devToolsVersion = Field(
    'devToolsVersion',
    _$devToolsVersion,
    opt: true,
  );
...
mixin FlutterRootVersionFileMappable {
  ...
  String toString() {
    return FlutterRootVersionFileMapper.ensureInitialized().stringifyValue(
      this as FlutterRootVersionFile,
    );
  }

  @override
  bool operator ==(Object other) {
    return FlutterRootVersionFileMapper.ensureInitialized().equalsValue(
      this as FlutterRootVersionFile,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return FlutterRootVersionFileMapper.ensureInitialized().hashValue(
      this as FlutterRootVersionFile,
    );
  }
}
