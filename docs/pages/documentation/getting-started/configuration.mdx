...
<Callout type="tip">
  Need IDE-specific steps? Follow the{" "}
  <a href="/documentation/guides/workflows#android-studio--intellij">
    Android Studio and IntelliJ workflow guide
  </a>{" "}
  to point the IDE at the project's `.fvm/flutter_sdk` symlink and refresh caches after switching versions.
</Callout>
