...
<Callout type="info">
  Seeing <code>Error: Unable to find git in your PATH</code> after installing on
  Windows? Follow the
  <a href="/documentation/troubleshooting/git-safe-directory-windows">
    Git Safe Directory troubleshooting guide
  </a>
  to configure <code>safe.directory</code>.
</Callout>
