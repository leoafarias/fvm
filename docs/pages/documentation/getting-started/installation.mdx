...
You can download the standalone packages from the GitHub repo [here](https://github.com/conceptadev/fvm/releases).
...
Native Windows builds are published on the [GitHub Releases](https://github.com/conceptadev/fvm/releases/latest) page.
...
For alternative installation methods, see the [GitHub Releases](https://github.com/conceptadev/fvm/releases/latest) page.
...
- **Bash**: Add to `~/.bashrc`
- **Zsh**: Add to `~/.zshrc`
- **Fish**: Run `fish_add_path "<install_dir>/bin"`
