...
![GitHub stars](https://img.shields.io/github/stars/conceptadev/fvm?style=for-the-badge&logo=GitHub&logoColor=black&labelColor=white&color=dddddd)
...
[![All Contributors](https://img.shields.io/github/contributors/conceptadev/fvm?style=for-the-badge&color=018D5B&labelColor=004F32)](https://github.com/conceptadev/fvm/graphs/contributors)
[![MIT License](https://img.shields.io/github/license/conceptadev/fvm?style=for-the-badge&color=FF2E00&labelColor=CB2500)](https://opensource.org/licenses/mit-license.php)
![Codecov](https://img.shields.io/codecov/c/github/conceptadev/fvm?style=for-the-badge&color=FFD43A&labelColor=F3BE00)
...
2. **Create GitHub Release**
   - Go to [GitHub Releases](https://github.com/conceptadev/fvm/releases)
...
3. **Automated Deployment**
   ...
   - Monitor progress in [Actions tab](https://github.com/conceptadev/fvm/actions)
...
> chain via the `RELEASE_DART_SDK` environment variable (currently `3.13.0`) so
...
<a href="https://github.com/conceptadev/fvm/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=conceptadev/fvm" />
</a>
