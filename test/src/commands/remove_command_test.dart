...
void main() {
  group('RemoveCommand', () {
    test('should remove all versions when user confirms with --all flag',
        () async {
    ...
    test('should not remove versions when user declines with --all flag',
        () async {
    ...
    test('should use correct default value (false) for destructive operation',
        () async {
